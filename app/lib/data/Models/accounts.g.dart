...
extension AccountQueryFilter
  ...
  QueryBuilder<Account, Account, QAfterFilterCondition> isFavouriteEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
...
extension AccountQuerySortBy on QueryBuilder<Account, Account, QSortBy> {
  ...
  QueryBuilder<Account, Account, QAfterSortBy> sortByIsFavourite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavourite', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> sortByIsFavouriteDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountQuerySortThenBy
  ...
  QueryBuilder<Account, Account, QAfterSortBy> thenByIsFavourite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavourite', Sort.asc);
    });
  }

  QueryBuilder<Account, Account, QAfterSortBy> thenByIsFavouriteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavourite', Sort.desc);
    });
  }
...
extension AccountQueryWhereDistinct
  ...
  QueryBuilder<Account, Account, QDistinct> distinctByIsFavourite() {
    return QueryBuilder.apply(this, (query) {
...
extension AccountQueryProperty
  ...
  QueryBuilder<Account, bool, QQueryOperations> isFavouriteProperty() {
    return QueryBuilder.apply(this, (query) {
